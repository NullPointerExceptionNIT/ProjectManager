...
const Profile = () => {
    ...
    if (user == null) return (<div className="flex space-x-2 mr-5">
    ...
    else return (<div className="flex space-x-2 mr-5">
        <a onClick={logout} className="text-red-500 hover:underline">Logout</a>
    </div>
